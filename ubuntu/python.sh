...
if [ "$VERSION_ID" \< "18.04" ]; then
   echo "Depends: libpbc, libreadline6, libcrypto++9v5, libssl1.0.0, libcurl3" >> dcore-python3/DEBIAN/control
elif [ "$VERSION_ID" \< "19.04" ]; then
   echo "Depends: libpbc, libreadline7, libcrypto++6, libssl1.1, libcurl4, libboost-filesystem1.65.1, libboost-thread1.65.1, libboost-iostreams1.65.1, libboost-date-time1.65.1, libboost-chrono1.65.1, libboost-context1.65.1, libboost-python1.65.1" >> dcore-python3/DEBIAN/control
else
   echo "Depends: libpbc, libreadline8, libcrypto++6, libssl1.1, libcurl4, libboost-filesystem1.67.0, libboost-thread1.67.0, libboost-iostreams1.67.0, libboost-date-time1.67.0, libboost-chrono1.67.0, libboost-context1.67.0, libboost-python1.67.0" >> dcore-python3/DEBIAN/control
fi
...
mv packages/dcore-python3_${DCORE_VERSION}_amd64.deb packages/dcore-python3_${DCORE_VERSION}-ubuntu${VERSION_ID}_amd64.deb
