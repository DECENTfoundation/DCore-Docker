...
if [ "$VERSION_ID" \< "18.04" ]; then
   ...
   echo "Depends: libpbc, libreadline8, libcrypto++6, libssl1.1, libcurl4" >> dcore-node/DEBIAN/control
fi
...
if [ "$VERSION_ID" \< "18.04" ]; then
   ...
   echo "Depends: libpbc, libreadline8, libcrypto++6, libssl1.1, libcurl4, qt5-default" >> dcore-gui/DEBIAN/control
fi
